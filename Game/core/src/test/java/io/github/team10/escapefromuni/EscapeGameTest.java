...
public class EscapeGameTest extends HeadlessTestRunner {
    ...
    public void tearDown() {
        // No need to dispose mocked objects
        game = null;
    }
    ...
    public void ViewportDimensions() {
        // Test that the viewport dimensions are as expected
