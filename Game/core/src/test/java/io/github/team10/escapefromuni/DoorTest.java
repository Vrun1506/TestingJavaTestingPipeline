...
public class DoorTest extends HeadlessTestRunner {
    ...
    @Before
    public void setUp() {
        // Mock RoomManager and EscapeGame
    ...
    public void tearDown() {
        // Delete the door object after the test.
        if (door != null) {
            door.dispose();
        }
    }
    ...
    public void DoorPosition() {
        // Test that the door is positioned correctly
    ...
    public void DoorSize() {
        // Test that the door has correct size
    ...
    public void DoorDirections() {
        // Test creating doors with different directions
